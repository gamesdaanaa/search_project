...
# セッションセキュリティ設定
SESSION_COOKIE_AGE = 1800  # 30分でセッション期限切れ
...
SESSION_SAVE_EVERY_REQUEST = True  # セッションを毎リクエスト更新
SESSION_COOKIE_SAMESITE = 'Lax'

# ログイン試行回数制限
AXES_ENABLED = True
AXES_FAILURE_LIMIT = 3  # 3回の失敗でロック
...
FILE_UPLOAD_MAX_MEMORY_SIZE = 10 * 1024 * 1024  # 10MB制限
